    ...
    `<div class="row">
      ...
      <div class="col-3 d-flex align-items-center" style="background-color:#FFFFFF; ">
        <div class="d-flex " style='flex-direction:column'>
          ...
          <label class='label m-1' style='border:none'>Systolic BP: <span id="dataOne">127</span></label>
          <label class='label m-1' style='border:none'>Diastolic BP: <span id="dataTwo">68</span></label>
          <label class='label m-1' style='border:none'>Millimetres of mercury (mmHg)</label>
